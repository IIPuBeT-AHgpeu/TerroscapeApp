...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "game_name", new[] { "base", "feral_instincts", "amorphous_peril", "lethal_immortals", "putrefied_enmity" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "killer_win", new[] { "murder", "time", "other" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "survivor_state", new[] { "alive", "injured", "dead" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "survivor_win", new[] { "escape", "police", "plan", "other" });
